...
export const COLLAPSED_TAB_HEIGHT = 34;
export const EXPANDED_TAB_SURFACE_HEIGHT = 48;
export const COLLAPSED_TAB_VISIBLE_EDGE_WIDTH = 18;
export const ROOT_RIGHT_OFFSET = 50;
export const RAIL_VIEWPORT_DEFAULT_TOP = 94;
...
export const BOOKMARK_HISTORY_LIMIT = 5;
